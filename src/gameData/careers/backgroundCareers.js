...
const backgroundCareers = [
  ...
  },
  {
    ...
    baseAcademicSkillPoints: [15],
    baseFreeSkillPoints: [0],
    baseStridsvanaPoints: [0],
    promotion: 'Scholar',
    startingCapital: [100],
    eventTable: 'medelklassenBackgroundEvents',
    associatedSkills: ['Dans', 'Förföra', 'Idrott', 'Köra/bil', 'Musik', 'Simma', 'Socialt uppträdande', 'Övertalning'],
    academicSkills: [ 'Administration', 'Biologi', 'Datateknik', 'Ekonomi', 'Fysik', 'Historia', 'Kemi', 'Matematik', 'Media', 'Programmering', 'Psykologi', 'Skriva/Läsa'],
    restrictions: [],
    yearsInCareer: 4,
    bilMod: 0,
    genetics: false
  },
  {
    ...
    eventTable: 'overklassenBackgroundEvents',
    associatedSkills: ['Dans', 'Förföra', 'Geografi', 'Köra/bil', 'Ledarskap', 'Politik', 'Simma', 'Socialt uppträdande', 'Stil & smak', 'Övertalning'],
    academicSkills: [ 'Administration', 'Biologi', 'Datateknik', 'Ekonomi', 'Fysik', 'Historia', 'Kemi', 'Matematik', 'Media', 'Programmering', 'Psykologi', 'Skriva/Läsa'],
    restrictions: [],
    yearsInCareer: 4,
    bilMod: '1T6-2',
  ...
  },
  {
    ...
    eventTable: 'socialElitBackgroundEvents',
    associatedSkills: ['Dans', 'Förföra', 'Geografi', 'Köra/bil', 'Ledarskap', 'Simma', 'Socialt uppträdande', 'Stil & smak', 'Övertalning'],
    academicSkills: [ 'Administration', 'Biologi', 'Datateknik', 'Ekonomi', 'Fysik', 'Historia', 'Kemi', 'Matematik', 'Media', 'Programmering', 'Psykologi', 'Skriva/Läsa', 'Språk'],
    restrictions: [],
    yearsInCareer: 4,
    bilMod: '1T6-3',
    genetics: true
