...
export const advantagesEvents = [
  ...
  { min: 6, max: 6, description: "Blixtrande reflexer. Färdigheten Dra vapen är lättlärd. Dessutom modifieras rollpersonens turordning med en fast modifikation på tio (+10).",  modifiers: [{type: 'lattlard', skill: 'Dra Vapen' }, {type: 'secondary_attribute', name: 'Turordning', modifier: 10 }] },
  { min: 7, max: 7, description: "Bollsinne. Har lätthet för att kasta och ta emot. Färdigheten Kasta är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Kasta' }] },
  ...
  { min: 10, max: 10, description: "Charmroll. Färdigheten Förföra är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Förföra' }] },
  ...
  { min: 16, max: 16, description: "Extrovert människa. Färdigheten Socialt uppträdande är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Socialt Uppträdande' }] },
  { min: 17, max: 17, description: "Extermt fingerfärdig. Färdigheten Fingferfärdighet är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Fingerfärdighet' }]  },
  { min: 18, max: 18, description: "Fisker i vatten. Färdigheterna Simma och Dykning är lättlärda.", modifiers: [{type: 'lattlard', skill: 'Simma' }, {type: 'lattlard', skill: 'Dykning' } ] },
  { min: 19, max: 19, description: "Flyfotad. Förflyttningen ökar med två (+2) meter per runda.",  modifiers: [{type: 'secondary_attribute', name: 'forflyttning', value: 2 }] },
  ...
  { min: 24, max: 24, description: "Född lärare. Färdigheten Undervisning är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Undervisning' }] },
  { min: 25, max: 25, description: "Född pilot. Färdigheten Pilot-helikopter är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Pilot' }] },
  { min: 26, max: 26, description: "Född spelare. Färdigheten Hasardspel är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Hasardspel' }] },
  { min: 27, max: 27, description: "Författare. Färdigheten Skriva/läsa är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Skriva/Läsa' }] },
  { min: 28, max: 28, description: "Förförarexpert. Färdigheten Förföra är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Förföra' }] },
  ...
  { min: 35, max: 35, description: "Helare. Färdigheten Första hjälpen är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Första Hjälpen' }]},
  { min: 36, max: 36, description: "Idrottare. Färdigheten Idrott är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Idrott' }] },
  ...
  { min: 38, max: 38, description: "Jaktinstinkt. Färdigheten Jakt är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Jakt' }] },
  ...
  { min: 41, max: 41, description: "Klättrare. Färdigheten Klättra är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Kasta' }] },
  { min: 42, max: 42, description: "Knivkastarexpert. Färdigheten Kastkniv är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Kastkniv' }] },
  { min: 43, max: 43, description: "Konstnärssjäl. Färdigheterna Konstnämend och Design är lättlärda.", modifiers: [{type: 'lattlard', skill: 'Konstkännedom' }, {type: 'lattlard', skill: 'Design' }] },
  { min: 44, max: 44, description: "Kylig. Rollpersonens Cool höjs med två (+2). Detta kan även medföra att Turordningen behöver räknas om.", modifiers: [{type: 'secondary_attribute', name: 'Cool', modifier: 2}]  },
  { min: 45, max: 45, description: "Gourmet. Färdigheten Matlagning är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Matlagning' }]  },
  ...
  { min: 48, max: 48, description: "Matematiskt snille. Färdigheten Matematik är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Matematik' }]  },
  { min: 49, max: 49, description: "Mental balans. Blås ej mot rollpersonens Mentalvärde är alltid en nivå enklare (−Ob1T6)." },
  { min: 50, max: 50, description: "Modelejon. Färdigheten Stil & Smak är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Stil & smak' }]  },
  ...
  { min: 52, max: 52, description: "Musikaliskt geni. Färdigheten Musik är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Musik' }]  },
  ...
  { min: 57, max: 57, description: "Naturlig bilförare. Färdigheten Köra: bil är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Köra Bil' }] },
  { min: 58, max: 58, description: "Naturlig fotograf. Färdigheten Foto & film är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Foto & Film' }] },
  { min: 59, max: 59, description: "Naturlig ledare. Färdigheten Ledarskap är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Ledarskap' }] },
  { min: 60, max: 60, description: "Naturlig skytt. Färdigheterna Pistol och Gevär är lättlärda.", modifiers: [{type: 'lattlard', skill: 'Pistol' }, {type: 'lattlard', skill: 'Gevär' }] },
  { min: 61, max: 61, description: "Observant. Färdigheterna Spaning och Genomsöka är lättlärda.", modifiers: [{type: 'lattlard', skill: 'Spaning' }, {type: 'lattlard', skill: 'Genomsöka' }] },
  ...
  { min: 65, max: 65, description: "Pedagog. Färdigheten Undervisning är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Undervisning' }] },
  ...
  { min: 67, max: 67, description: "Reflexsnabb. Rollpersonens turordning modifieras med en fast modifikation på fem (+5).",  modifiers: [{type: 'secondary_attribute', name: 'Turordning', modifier: 5}] },
  ...
  { min: 70, max: 70, description: "Rymdmänniska. Färdigheten Fritt fall är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Fritt Fall' }]  },
  ...
  { min: 73, max: 73, description: "Sinne för värdering. Färdigheten Värdering är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Värdera' }] },
  ...
  { min: 78, max: 78, description: "Smygare. Färdigheten Smyga är lättlärd.", modifiers: [{type: 'lattlard', skill: 'Smyga' }]   },
  ...
  { min: 92, max: 92, description: "Tursam. Öka rollpersonens Tur med +1T6.", modifiers: [{type: 'secondary_attribute', name: 'Tur', modifier: "1T6" }] },
...
export const disadvantagesEvents = [
  ...
  { min: 62, max: 62, description: "Olyckskorp: Rollpersonen har otur i alla tänkbara situationer.",  modifiers: [{type: 'secondary_attribute', modifier: '-2', name: 'Tur' }] },
